      ...
      <section className="hero bg-primary py-8">
        <Container className="flex items-center justify-between md:flex-row flex-col">
          <div className="w-full md:w-1/2 text-white pr-12">
            ...
            "Smooth transitions make everything easier. Maintain a steady flow by aligning your approach to the rhythm of your goals. Let actions be deliberate, ensuring balance and consistency. Adapt with confidence, combining flexibility with determination."
            </Body>
            <SearchBox />
